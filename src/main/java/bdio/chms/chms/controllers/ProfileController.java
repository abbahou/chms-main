...
public class ProfileController {
    ...
    private static final String DASHBOARD_VIEW = "/bdio/chms/chms/fxml/Dashboard.fxml";
    private static final String PROFILE_VIEW = "/bdio/chms/chms/fxml/Profile.fxml";
    private static final String MEDICATION_VIEW = "/bdio/chms/chms/fxml/Medicament.fxml";
    private static final String ORDONNANCE_VIEW = "/bdio/chms/chms/fxml/Ordonnance.fxml";
    private static final String LOGIN_VIEW = "/bdio/chms/chms/fxml/Login.fxml";
    private static final String FOURNISSEUR_VIEW = "/bdio/chms/chms/fxml/Fournisseur.fxml";
